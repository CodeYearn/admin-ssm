...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form
				action="${pageContext.request.contextPath}/authority/addRoleToAuthority.do"
				method="post">
				<!-- 正文区域 -->
				...
				<input type="hidden" name="authorityID" value="${authority.authorityID}">
					...
					<table id="dataList"
							...
							<tbody>
								<c:forEach items="${otherRole}" var="role">
									<tr>
										<td>
										
										<input name="ids" type="checkbox" value="${role.roleID}">
